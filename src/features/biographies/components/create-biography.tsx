...
import { useFormCreateBiography } from "../hooks/use-form-create-biography";
...
const CreateBiography = () => {
    ...
    const {fields, onHandleSubmit, loadingCreate, setFieldValue} = useFormCreateBiography()
    ...
    return (
        <Card className="flex relative flex-col lg:items-start justify-center items-center">
            <h3 className="text-primary text-3xl mb-[2rem] text-center w-full">Crear Biografía</h3>
                    ...
                    <div className="flex flex-col lg:flex-row p-4 w-full gap-6 justify-between ">
                        ...
                        <div className="flex flex-col gap-4  w-full">
                            ...
                            <TabSlider tabs={tabs}>
                                ...
                                <PhotosBiography onChangePhotos={photos=>setFieldValue("photos", photos)}/>
                                <VideosBiography onChangeVideos={videos=>setFieldValue("videos", videos)}/>
                                <MessagesBiography initialMessage={[]} onChangeMessage={msgs=>setFieldValue("messages", msgs)}/>
                            </TabSlider>
                        </div>
                    </div>
                </div>
